...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label38" runat="server" Text="My profile"></asp:Label>
            &nbsp;
        ...
        <br />
            <br />
        <br />
        <asp:Button ID="delete" runat="server" Text="delete guest" OnClick="delete_Click"  class ="button-34"  />
        <br />
        <asp:Label ID="Label22" runat="server" Text="" CssClass ="label2"></asp:Label>
            ...
            <br />
        <br />
        <asp:Button ID="ViewNumber" runat="server" Text="view" OnClick="ViewNumber_Click"  class ="button-34"  />
        <br />
        ...
        <br />
            <br />
        <br />
        <asp:Button ID="setNumber" runat="server" Text="set number" OnClick="setNumber_Click"  class ="button-34"   />
        <br />
        ...
        <asp:Button ID="addGuest" runat="server" Text="Add guest" OnClick="addGuest_Click"   class ="button-34"  />
        <br />
